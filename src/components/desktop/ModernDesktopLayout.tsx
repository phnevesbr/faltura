...
import AdvancedSubjectManager from '../advanced/AdvancedSubjectManager';
import AdvancedAbsenceManager from '../advanced/AdvancedAbsenceManager';
...
import { ModernClassManager } from './ModernClassManager';
...
const ModernDesktopLayout: React.FC<ModernDesktopLayoutProps> = ({ user, signOut }) => {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'subjects':
        return <AdvancedSubjectManager />;
      case 'absences':
        return <AdvancedAbsenceManager />;
      case 'notes':
        return <NotesManager />;
      case 'stats':

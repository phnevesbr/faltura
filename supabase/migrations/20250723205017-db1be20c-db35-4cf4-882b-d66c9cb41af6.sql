-- Criar enum para tipos de papel incluindo professor
DO $$ BEGIN
    CREATE TYPE public.user_role_type AS ENUM ('super_admin', 'admin', 'moderator', 'teacher', 'student');
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;

-- Atualizar tabela admin_roles para usar o enum (se não estiver usando)

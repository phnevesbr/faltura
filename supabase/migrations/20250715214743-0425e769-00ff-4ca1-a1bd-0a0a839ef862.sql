-- Migração corrigida para criar 20 usuários de exemplo com dados completos
...
INSERT INTO public.profiles (
  ...
  ('44444444-4444-4444-4444-444444444444', 'pedro.oliveira@email.com', 'Engenharia de Software', 'PUC-SP', 'night', '2024-03-01', '2024-07-15', null),
  ...
  ('66666666-6666-6666-6666-666666666666', 'rafael.rodrigues@email.com', 'Análise e Desenvolvimento', 'FATEC', 'night', '2024-03-01', '2024-07-15', null),
  ...
  ('99999999-9999-9999-9999-999999999999', 'fernanda.lima@email.com', 'Sistemas de Informação', 'UFG', 'night', '2024-03-01', '2024-07-15', null),
  ...
  ('cccccccc-cccc-cccc-cccc-cccccccccccc', 'gustavo.ribeiro@email.com', 'Análise e Desenvolvimento', 'IFSP', 'night', '2024-03-01', '2024-07-15', null),
  ...
  ('ffffffff-ffff-ffff-ffff-ffffffffffff', 'amanda.dias@email.com', 'Sistemas de Informação', 'UFPE', 'night', '2024-03-01', '2024-07-15', null),
  ...
  ('30303030-3030-3030-3030-303030303030', 'felipe.cruz@email.com', 'Análise e Desenvolvimento', 'SENAC', 'night', '2024-03-01', '2024-07-15', null),

-- Verificar e corrigir a função get_system_analytics
-- Primeiro vamos ver se a função está causando o problema
DROP FUNCTION IF EXISTS public.get_system_analytics(integer);
